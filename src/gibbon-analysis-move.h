...
enum {
        GIBBON_ANALYSIS_MOVE_DA_PWIN = 0,
        GIBBON_ANALYSIS_MOVE_DA_PWIN_GAMMON,
        GIBBON_ANALYSIS_MOVE_DA_PWIN_BACKGAMMON,
        GIBBON_ANALYSIS_MOVE_DA_PLOSE_GAMMON,
        GIBBON_ANALYSIS_MOVE_DA_PLOSE_BACKGAMMON,
